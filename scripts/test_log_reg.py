...
if __name__ == "__main__":
    ...
    w_0=  [[0], [-8.26279236e-03], [-3.96211063e-03], [ 3.53882825e+01],[0],[0],[0], [ 1.08146348e-01], [-3.53919467e+01], [-1.28569882e-01], [-5.09353615e-01], [ 5.83419533e-02], [0], [ 1.23131590e-01], [-7.69579092e-04], [-1.23140038e-03], [ 1.47200427e-01], [ 4.24308544e-03], [-6.29127830e-04], [ 3.33966778e-03], [-2.16377809e-03], [ 5.18145441e-06],[0],[0],[0],[0],[0],[0],[0],[0]]
    w_1=  [[ 2.65098186e-04], [-8.75722696e-03], [-2.38362277e-03], [-4.02699440e-03],[0],[0],[0], [-4.60691111e-02], [ 2.85356766e-03], [-4.39467597e+00], [-4.52221258e-01], [ 1.35234811e-01],[0], [ 4.39512000e+00], [ 3.01854872e-03], [-2.68881412e-03], [ 4.40972121e+00], [-6.80752658e-03], [-3.21421635e-04], [ 3.90591124e-03], [ 2.22975440e-03], [-1.35486659e-03],[0], [-5.70148464e+01], [-1.26229990e-04], [ 1.18813870e-05],[0],[0],[0], [ 6.14119588e+01]]
    ...
    for i in range(0,len(tX_test)):
        if tX_test[i,22] == 0:
            y_pred[i] = np.dot(tX_test[i], w_0)
        if tX_test[i,22] == 1:
            y_pred[i] = np.dot(tX_test[i], w_1)
        else:
